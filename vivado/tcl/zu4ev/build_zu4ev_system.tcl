...
create_bd_cell -type ip -vlnv xilinx.com:ip:smartconnect:* data_smc
...
set_property -dict [list CONFIG.NUM_SI {2} CONFIG.NUM_MI {1}] [get_bd_cells data_smc]
set_property -dict [list \
...
connect_bd_intf_net [get_bd_intf_pins data_smc/M00_AXI] [get_bd_intf_pins ps_0/S_AXI_HPC0_FPD]
